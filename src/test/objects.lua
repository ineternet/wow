...
local str = habitat:require(root.Strings)
...
print("Agony has", enemy:findFirstAura(const.Auras.Agony).stacks, " stacks and will remain for:", str.Timer.AuraTimer(enemy:findFirstAura(const.Auras.Agony):remainingTime()))
print("Skipping 9s.")
