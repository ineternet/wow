...
print("Corruption will remain for:", const.AuraTimer(enemy:findFirstAura(const.Auras.Corruption):remainingTime()))
...
env.UnreplicatedTimeTravel(5)
print("Enemy HP:", enemy.primaryResourceAmount)
print("Reapplying Corruption:", tu:wantToCast(const.Spells.Corruption))
print("Corruption will remain for:", const.AuraTimer(enemy:findFirstAura(const.Auras.Corruption):remainingTime()))