...
tu.spellbook:learn(const.Spells.Spellsteal)
tu.spellbook:learn(const.Spells.Kleptomancy)
tu.spellbook:learn(const.Spells.Corruption)
tu.spellbook:learn(const.Spells.Agony)
tu.spellbook:learn(const.Spells.AfflictionFelEnergy)
